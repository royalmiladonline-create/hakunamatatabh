...
/**
 * Hooks for InventoryTransaction routes
 */
export interface InventoryTransactionHooks {
  /**
...
/**
 * Default InventoryTransaction hooks (customize as needed)
 */
export const inventoryTransactionHooks: InventoryTransactionHooks = {
