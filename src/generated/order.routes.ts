...
const WRITABLE_SCALAR_FIELDS = ["orderNumber", "type", "status", "subtotal", "tax", "total", "paymentMethod", "paymentStatus", "deliveryPlatform", "notes", "createdAt", "updatedAt", "completedAt", "tableId", "staffId"] as const
const RELATION_FIELDS = ["table", "staff", "items"] as const
