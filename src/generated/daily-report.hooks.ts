...
/**
 * Hooks for DailyReport routes
 */
export interface DailyReportHooks {
  /**
...
/**
 * Default DailyReport hooks (customize as needed)
 */
export const dailyReportHooks: DailyReportHooks = {
