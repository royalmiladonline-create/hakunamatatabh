...
/**
 * Hooks for MenuCategory routes
 */
export interface MenuCategoryHooks {
  /**
...
/**
 * Default MenuCategory hooks (customize as needed)
 */
export const menuCategoryHooks: MenuCategoryHooks = {
