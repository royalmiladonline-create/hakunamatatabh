...
/**
 * Hooks for InventoryItem routes
 */
export interface InventoryItemHooks {
  /**
...
/**
 * Default InventoryItem hooks (customize as needed)
 */
export const inventoryItemHooks: InventoryItemHooks = {
